...
const data = {
  books: [
    ...
    },
    {
      ...
      date: '09-06-2017',
      intro: 'As you may know by now, I am a huge middle-grade books fan! Fun fact: I was more attracted to adult books when in high school... And more attracted to middle-grade books now that I\'m—presumably—an adult! So, here is a my top 5 favorite middle-grade books of all time. Disclaimer: it may include witches.',
